        ...
        try:
            ...
            if NEG > NEU:
                if NEG > POS:
                    ...
                    messagebox.showinfo("Alert", "Negative Emotion" + ' ' + str(NEG))
                    # video_url = "https://www.youtube.com/watch?v=Er8D49RPLCs&list=RDEr8D49RPLCs&start_radio=1"
                    # webbrowser.open_new_tab(video_url)
                    negtivte()
                else:
                    print("Positive Emotion", POS)
                    messagebox.showinfo("Alert", "Positive Emotion" + ' ' + str(POS))
                    # video_url = "https://www.youtube.com/watch?v=unQlCp-lL6I&list=RDEr8D49RPLCs&index=2"
                    # webbrowser.open_new_tab(video_url)
                    show_links()
            else:
                if NEU > POS:
                    print("Neutral Emotion", NEU)
                    messagebox.showinfo("Alert", "Neutral Emotion" + ' ' + str(NEU))
